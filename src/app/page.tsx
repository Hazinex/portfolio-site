    ...
    <>
      ...
      <section className="flex flex-col flex-1 items-center justify-center m-4">
        ...
        <div className="flex flex-col pt-8 text-center">
          ...
          <p className={`${sansation.className} text-lg animate-fly-up [animation-delay:2.5s] opacity-0`}>Passionate about technology since my childhood, made my hobby my job.</p>
        </div>
