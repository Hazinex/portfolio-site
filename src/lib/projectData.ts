...
export const MainProjectsData: ProjectType[] = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      { number: 4, header: "V1.1 First update (27/01/26)", content: "The first update focusses mainly on the projects pages and the projects within. I've added a tab for 'mini projects' for things that are interesting but not exactly big or grandiose. I wanted to update the look of the main projects page because it felt outdated as soon as I published it. The hover zoom also caused text and images to change visually until the animation had finished which was very jarring. As a form of future proofing, I also added filters for when I have some more projects to show here, or for when recruiters want to see projects with a particular skill/technology. On the actual project pages I added video functionality, the ability to [link]( https://www.harryellis.dev/), and have **Bold** and *Italic* text on the pages." },
